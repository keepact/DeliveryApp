...
## libs used:
  
  <strong>Frontend</strong>: react-router-dom, axios, styled-components, react-lottie, prop-types, react-geocode, react-google-maps, polished and @rocketseat/unform
